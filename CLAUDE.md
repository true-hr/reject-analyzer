...
The rule is: read-only inspection can be auto-allowed; state-changing, security-sensitive, or production-impacting actions require explicit user confirmation.
