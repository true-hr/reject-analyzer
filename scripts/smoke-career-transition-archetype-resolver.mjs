...
const CASES = [
  ...
  },
  {
    id: 'SC-MK1',
    input: {
      sourceJobId: 'JOB_MARKETING_BRAND_MARKETING',
      targetJobId: 'JOB_BUSINESS_SERVICE_PLANNING',
      sourceSubType: null,
      targetSubType: null,
      yearsOfExperience: 4,
      sourceIndustryId: 'INDUSTRY_CONSUMER_GOODS',
      targetIndustryId: 'INDUSTRY_IT_PLATFORM',
      candidateEvidencePack: { hasMetricEvidence: false, hasProcessImprovementEvidence: false, hasCrossFunctionalEvidence: false, hasCustomerProblemEvidence: false },
    },
    expected: {
      resolutionStatus: 'ARCHETYPE_MATCH',
      selectedArchetypeId: 'BRAND_MARKETING_TO_SERVICE_PLANNING',
      requiredPhrases: ['브랜드마케팅 경험은 서비스기획 전환에서 사용자가 서비스를 어떻게 인식하고 받아들이는지 이해했다는 강점으로 연결될 수 있습니다'],
      forbiddenPhrases: ['입력된 직무 정보로는 전환 경로를 정확하게 분析하기 어렵습니다'],
    },
  },
  {
  ...
  },
  {
    ...
    expected: {
      resolutionStatus: 'ARCHETYPE_WITH_MODIFIER',
      selectedArchetypeId: 'BRAND_MARKETING_TO_BUSINESS_PLANNING',
      requiredPhrases: ["브랜드마케팅 경험은 사업기획 전환에서 '시장 포지션과 고객 인식을 사업 기회로 해석한 경험'으로 연결될 수 있습니다"],
      forbiddenPhrases: ['입력된 직무 정보로는 전환 경로를 정확하게 분析하기 어렵습니다'],
    },
  },
  {
    id: 'SC-MK4',
    input: {
      sourceJobId: 'JOB_MARKETING_CRM_MARKETING',
      targetJobId: 'JOB_BUSINESS_SERVICE_PLANNING',
      sourceSubType: null,
      targetSubType: null,
      yearsOfExperience: 4,
    ...
    expected: {
      resolutionStatus: 'ARCHETYPE_MATCH',
      selectedArchetypeId: 'CRM_MARKETING_TO_SERVICE_PLANNING',
      requiredPhrases: ['CRM마케팅 경험은 서비스기획 전환에서 꽤 좋은 연결점이 될 수 있습니다'],
      forbiddenPhrases: ['입력된 직무 정보로는 전환 경로를 정확하게 분析하기 어렵습니다'],
    },
  },
  {
  ...
  },
  {
    ...
    expected: {
      resolutionStatus: 'ARCHETYPE_WITH_MODIFIER',
      selectedArchetypeId: 'CRM_MARKETING_TO_BUSINESS_PLANNING',
      requiredPhrases: ["CRM마케팅 경험은 사업기획 전환에서 '고객 유지와 매출 구조를 데이터로 본 경험'으로 연결될 수 있습니다"],
      forbiddenPhrases: ['입력된 직무 정보로는 전환 경로를 정확하게 분析하기 어렵습니다'],
    },
  },
  {
    id: 'SC-MK7',
    input: {
      sourceJobId: 'JOB_MARKETING_DIGITAL_MARKETING',
      targetJobId: 'JOB_BUSINESS_SERVICE_PLANNING',
      sourceSubType: null,
      targetSubType: null,
      yearsOfExperience: 3,
    ...
    expected: {
      resolutionStatus: 'ARCHETYPE_WITH_MODIFIER',
      selectedArchetypeId: 'DIGITAL_MARKETING_TO_SERVICE_PLANNING',
      requiredPhrases: ["디지털마케팅 경험은 서비스기획 전환에서 '고객 반응을 근거로 서비스 개선점을 찾는 경험'으로 연결될 수 있습니다"],
      forbiddenPhrases: ['입력된 직무 정보로는 전환 경로를 정확하게 분析하기 어렵습니다'],
    },
  },
  {
    ...
    expected: {
      resolutionStatus: 'ARCHETYPE_WITH_MODIFIER',
      selectedArchetypeId: 'DIGITAL_MARKETING_TO_PRODUCT_MANAGEMENT',
      requiredPhrases: ["디지털마케팅 경험은 PM 전환에서 '고객 반응과 성장 지표를 제품 의사결정에 연결하는 강점'으로 활용될 수 있습니다"],
      forbiddenPhrases: ['입력된 직무 정보로는 전환 경로를 정확하게 분析하기 어렵습니다'],
    },
  },
  {
  ...
  },
  {
    id: 'SC-MK10',
    input: {
      sourceJobId: 'JOB_MARKETING_CONTENT_MARKETING',
      targetJobId: 'JOB_BUSINESS_SERVICE_PLANNING',
      sourceSubType: null,
      targetSubType: null,
      yearsOfExperience: 3,
      sourceIndustryId: 'INDUSTRY_MEDIA',
      targetIndustryId: 'INDUSTRY_IT_PLATFORM',
      candidateEvidencePack: { hasMetricEvidence: false, hasProcessImprovementEvidence: false, hasCrossFunctionalEvidence: false, hasCustomerProblemEvidence: false },
    },
    expected: {
  ...
  },
  {
    ...
    expected: {
      resolutionStatus: 'ARCHETYPE_WITH_MODIFIER',
      selectedArchetypeId: 'CONTENT_MARKETING_TO_PRODUCT_MANAGEMENT',
      requiredPhrases: ["콘텐츠마케팅 경험은 PM 전환에서 '고객 문제와 메시지 반응을 제품 방향으로 해석하는 강점'이 될 수 있습니다"],
      forbiddenPhrases: ['입력된 직무 정보로는 전환 경로를 정확하게 분析하기 어렵습니다'],
    },
  },
  {
    ...
    expected: {
      resolutionStatus: 'ARCHETYPE_WITH_MODIFIER',
      selectedArchetypeId: 'CONTENT_MARKETING_TO_BUSINESS_PLANNING',
      requiredPhrases: ["콘텐츠마케팅 경험은 사업기획 전환에서 '고객 니즈와 시장 반응을 읽은 경험'으로 연결될 수 있습니다"],
      forbiddenPhrases: ['입력된 직무 정보로는 전환 경로를 정확하게 분析하기 어렵습니다'],
    },
  },
  {
    ...
    expected: {
      resolutionStatus: 'ARCHETYPE_WITH_MODIFIER',
      selectedArchetypeId: 'SALES_B2B_TO_BUSINESS_PLANNING',
      requiredPhrases: ['B2B영업 경험은 사업기획 전환에서 중요한 현장 기반 강점이 될 수 있습니다'],
      forbiddenPhrases: ['입력된 직무 정보로는 전환 경로를 정확하게 분析하기 어렵습니다'],
    },
  },
  {
  ...
  },
  {
    ...
    expected: {
      resolutionStatus: 'ARCHETYPE_WITH_MODIFIER',
      selectedArchetypeId: 'SALES_B2B_TO_SERVICE_PLANNING',
      requiredPhrases: ["B2B영업 경험은 서비스기획 전환에서 '고객 요구를 서비스 개선 과제로 발견한 경험'으로 활용될 수 있습니다"],
      forbiddenPhrases: ['입력된 직무 정보로는 전환 경로를 정확하게 분析하기 어렵습니다'],
    },
  },
  {
    ...
    expected: {
      resolutionStatus: 'ARCHETYPE_WITH_MODIFIER',
      selectedArchetypeId: 'ACCOUNT_MANAGEMENT_TO_BUSINESS_PLANNING',
      requiredPhrases: ['영업관리(Account Management) 경험은 사업기획 전환에서 고객과 시장을 직접 다룬 현장 강점으로 연결될 수 있습니다'],
      forbiddenPhrases: ['입력된 직무 정보로는 전환 경로를 정확하게 분析하기 어렵습니다'],
    },
  },
  {
    ...
    expected: {
      resolutionStatus: 'ARCHETYPE_WITH_MODIFIER',
      selectedArchetypeId: 'ACCOUNT_MANAGEMENT_TO_PRODUCT_MANAGEMENT',
      requiredPhrases: ['"고객이 실제로 어떤 문제를 겪는지 아는 사람"이라는 강점으로 읽힐 수 있습니다'],
      forbiddenPhrases: ['입력된 직무 정보로는 전환 경로를 정확하게 분析하기 어렵습니다'],
    },
  },
  {
    ...
    expected: {
      resolutionStatus: 'ARCHETYPE_WITH_MODIFIER',
      selectedArchetypeId: 'SALES_ADMIN_TO_PRODUCT_MANAGEMENT',
      requiredPhrases: ["영업관리 경험은 PM 전환에서 '매출 흐름과 고객 대응 문제를 제품 개선 과제로 본 경험'으로 연결될 수 있습니다"],
      forbiddenPhrases: ['입력된 직무 정보로는 전환 경로를 정확하게 분析하기 어렵습니다'],
    },
  },
  {
    ...
    expected: {
      resolutionStatus: 'ARCHETYPE_WITH_MODIFIER',
      selectedArchetypeId: 'SALES_ADMIN_TO_SERVICE_PLANNING',
      requiredPhrases: ["영업관리 경험은 서비스기획 전환에서 '고객·영업 프로세스의 반복 문제를 개선 과제로 본 경험'으로 연결될 수 있습니다"],
      forbiddenPhrases: ['입력된 직무 정보로는 전환 경로를 정확하게 분析하기 어렵습니다'],
    },
  },
