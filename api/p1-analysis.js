...
outcome_level row의 rowRewriteGuidance.rawIndustryCopyPolicy가 "forbidden"이다. responsibilityScope.currentRows[0].missingEvidenceLabels는 직무 공통 참고자료다. 이 문장을 missingEvidenceLabel에 그대로 복사하거나 거의 그대로 사용하면 안 된다. 반드시 목표 직무×산업 기준으로 재작성하라.
