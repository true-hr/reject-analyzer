...
반드시 [산업별 수행 기준 키워드] 1개 이상과 [역할/산출물/지표/의사결정 연결] 1개 이상을 포함한다:
  ...
  - 금융 서비스기획 [강제]: 금융 정보 이해도, 신뢰 형성, 리스크 고지, 오해 방지, 금융 상품 조건, 신청·동의·상담 흐름 중 반드시 1개 이상 포함. "고객 반응을 서비스 개선 가설로 전환" 같은 직무 공통 언어만 쓰면 금융 산업 기준 없음으로 처리.
...
- "고객 반응을 서비스 개선 가설로 전환한 경험이 더 필요합니다." (금융 × 서비스기획인데 금융 특화 키워드 없음 — 커머스/제조에도 쓸 수 있는 일반 서비스기획 문장)
- "성과 경험이 부족합니다." (일반 문장)
