...
const FIXTURE_RULES: RuleFixture[] = [
  ...
  {
    id: "rule_web_push_permission_default_1800",
    personId: "person_demo_23",
    reminderKind: "experience_recall",
    cadence: "daily",
    daysOfWeek: [],
    timeLocal: "18:00",
    ...
    channels: [
      {
        name: "web_push",
        priority: 1,
        contactId: "contact_push_permission_default_1",
        contactStatus: "verified",
        consentTypesChecked: ["service_notification", "experience_recall_reminder", "web_push_device"],
        consentStatus: "granted",
        providerReady: true,
  ...
  {
    id: "rule_web_push_ownership_stale_1800",
    personId: "person_demo_24",
    reminderKind: "experience_recall",
    cadence: "daily",
    daysOfWeek: [],
    timeLocal: "18:00",
    ...
    channels: [
      {
        name: "web_push",
        priority: 1,
        contactId: "contact_push_ownership_stale_1",
        contactStatus: "verified",
        consentTypesChecked: ["service_notification", "experience_recall_reminder", "web_push_device"],
        consentStatus: "granted",
        providerReady: true,
  ...
  {
    id: "rule_web_push_ownership_revoked_1800",
    personId: "person_demo_25",
    reminderKind: "experience_recall",
    cadence: "daily",
    daysOfWeek: [],
    timeLocal: "18:00",
    ...
    channels: [
      {
        name: "web_push",
        priority: 1,
        contactId: "contact_push_ownership_revoked_1",
        contactStatus: "verified",
        consentTypesChecked: ["service_notification", "experience_recall_reminder", "web_push_device"],
        consentStatus: "granted",
        providerReady: true,
