                ...
                <AnimatePresence>
                  {(() => {
                    ...
                    const decisionToHypothesis = (r) => {
                      ...
                      // - id(ageGateRisk 등)는 제목 fallback에서 배제
                      // ------------------------------
