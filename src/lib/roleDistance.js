...
const EDGES = [
  ...
  ["UX 디자인", "프로덕트 디자인"],
  ["UI 디자인", "UX 디자인"],
  // ── [PATCH] 그래프 품질 보정: 클러스터 단절 해소 (append-only) ──
  ["브랜드 마케팅", "그로스 마케팅"],  // 마케팅 클러스터 연결 (브랜드/콘텐츠 ↔ 퍼포먼스/그로스/CRM)
  ["콘텐츠 마케팅", "CRM 마케팅"],    // 마케팅 클러스터 연결 (콘텐츠-CRM 캠페인 실무 겹침)
  ["운영 관리", "구매"],              // 운영/CS 클러스터 연결 (조달·운영 통합 담당 현실 반영)
  ["재무 기획", "회계"],             // 재무/회계 직접 연결 (재무기획-결산 겸직 현실 반영)
];
