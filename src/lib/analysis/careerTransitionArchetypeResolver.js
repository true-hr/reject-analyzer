...
const ARCHETYPE_TABLE = {
  ...
  'accounting:finance_planning': {
    ...
    overlays: {
      jobStructure: {
        lead: '회계 경험은 단순 결산 처리보다, 손익·비용·예산 데이터를 통해 사업 흐름을 해석하고 실적 차이와 의사결정 포인트를 설명해 본 경우 FP&A/재무기획 전환 근거가 될 수 있습니다.',
  ...
  'hr_operations:hrbp': {
    ...
    overlays: {
      jobStructure: {
        lead: 'HR운영 경험은 단순 인사 행정이 아니라, 제도 운영·구성원 이슈·현업 문의를 통해 조직 문제의 패턴과 개선 포인트를 읽어본 경우 HRBP 전환 근거가 될 수 있습니다.',
  ...
  'engineering:product_management': {
    ...
    overlays: {
      jobStructure: {
        lead: '개발 경험은 PM 전환에서 구현 제약과 기술적 의사결정을 이해한다는 강점이 됩니다. 다만 기술을 잘 아는 것만으로는 부족하고, 고객 문제 정의·기능 우선순위·제품 지표를 기술 판단과 함께 설명할 때 전환 설득력이 커집니다.',
  ...
  'brand_marketing:product_management': {
    ...
    overlays: {
      jobStructure: {
        lead: '브랜드마케팅 경험은 단순 캠페인 운영이 아니라, 고객 인식·차별화 포인트·시장 포지션을 제품 방향과 기능 우선순위로 번역해 본 경우 PM 전환 근거가 될 수 있습니다.',
  ...
  'crm_marketing:product_management': {
    ...
    overlays: {
      jobStructure: {
        lead: 'CRM마케팅 경험은 메시지 발송이나 쿠폰 운영을 넘어, 고객 세그먼트·리텐션 지표·이탈 원인을 분석해 제품 개선 과제로 연결해 본 경우 PM 전환 근거가 될 수 있습니다.',
  ...
  'business_planning:product_management': {
    ...
    overlays: {
      jobStructure: {
        lead: "사업기획 경험은 단순 전략 자료 작성이 아니라, 시장·매출모델·KPI를 제품 방향과 기능 우선순위로 연결해 본 경우 PM 전환 근거가 될 수 있습니다.",
        scoreReason:
  ...
  'content_marketing:service_planning': {
    ...
    overlays: {
      jobStructure: {
        lead: '콘텐츠마케팅 경험은 단순 제작량이 아니라, 고객 질문·검색 의도·전환 흐름을 읽고 정보를 구조화해 본 경험일 때 서비스기획의 화면·정책·사용자 여정 설계 근거가 될 수 있습니다.',
        scoreReason:
  ...
  'sales_b2b:product_management': {
    ...
    overlays: {
      jobStructure: {
        lead: 'B2B영업 경험은 단순 매출 성과가 아니라, 고객 요구·도입 장벽·반복되는 기능 요청을 제품 요구사항과 우선순위로 번역해 본 경우 PM 전환 근거가 될 수 있습니다.',
        scoreReason:
  ...
  'digital_marketing:business_planning': {
    ...
    overlays: {
      jobStructure: {
        lead: '디지털마케팅 경험은 단순 광고 운영이 아니라, 획득 채널·전환율·CAC·매출 기여를 보고 성장 과제를 해석한 경험일 때 사업기획 전환 근거로 연결될 수 있습니다.',
        scoreReason:
  ...
  'customer_success:business_development': {
    ...
    overlays: {
      jobStructure: {
        lead: 'Customer Success 경험은 단순 온보딩이나 문의 대응이 아니라, 고객 사용 패턴·재계약/업셀 가능성·확장 니즈를 읽고 사업 기회로 연결한 경우 BD 전환 근거가 될 수 있습니다.',
        scoreReason:
  ...
  'customer_support:cx_planning': {
    ...
    overlays: {
      jobStructure: {
        lead: '고객지원 경험은 단순 문의 응대가 아니라, 반복 문의·불만 유형·프로세스 병목을 패턴화해 고객 여정과 운영 정책 개선으로 연결해 본 경우 CX기획 전환 근거가 될 수 있습니다.',
        scoreReason:
