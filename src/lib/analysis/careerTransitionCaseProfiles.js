...
export const CAREER_TRANSITION_CASE_PROFILES = [
...

  {
    ...
    conflict: {
      ...
      notes: "JOB_BUSINESS_SERVICE_PLANNING을 PM·Operations·MFG_QA·TechSupport 프로파일과 공유함. source set 완전 분리로 co-fire 불가.",
    },
...

  {
    ...
    conflict: {
      ...
      notes: "JOB_BUSINESS_SERVICE_PLANNING을 CS·Operations·MFG_QA·TechSupport 프로파일과 공유함. source set 완전 분리로 co-fire 불가. CS bridge(VOC/반복문의/고객불편) 재사용 금지.",
    },
  ...
  {
    id: "SERVICE_PLANNING_TO_PRODUCT_MANAGER",
    status: "IMPLEMENTED",
    priority: "P0",
    sourceJobIds: [
      "JOB_BUSINESS_SERVICE_PLANNING",
    ...
    transitionType: "ADJACENT",
    bridgeTags: ["service_flow_planning", "feature_definition", "cross_functional_collaboration", "product_problem_framing"],
    limitationTags: ["output_document_centered", "product_ownership_needs_evidence", "metric_improvement_needs_evidence"],
    evidenceTags: ["ia_screen_flow", "feature_specification", "policy_definition", "design_dev_collaboration", "release_support"],
    targetAxes: ["jobStructure", "responsibilityScope"],
    targetSlots: {
      jobStructure: ["lead", "scoreReason", "criteria"],
      responsibilityScope: ["lead", "liftOrLimit"],
    ...
    overlays: {
      jobStructure: {
        lead: "서비스기획 경험은 PM 직무와 기본 구조가 많이 겹칩니다. 사용자 흐름을 정리하고, 기능을 정의하고, 개발·디자인 조직과 협업해 서비스를 출시하는 경험은 PM 업무의 중요한 기반입니다.",
        scoreReason: "다만 PM은 기획 산출물을 만드는 역할에서 한 단계 더 나아가, 제품이 풀어야 할 문제를 정하고 우선순위를 판단하며 출시 후 성과까지 확인하는 역할입니다. 따라서 기존 경험이 IA, 화면설계, 정책정리, 기능정의서 작성에 집중되어 있다면 서비스기획 적합도는 높지만, PM 적합도는 제품 판단력과 성과 개선 경험에 따라 달라집니다.",
        criteria: "이 축에서는 현재 서비스기획 경험이 PM의 핵심 역할인 문제 정의, 제품 방향 설정, 우선순위 판단, 기능 개선, 출시 후 성과 확인과 얼마나 직접 연결되는지를 봅니다.",
      },
      responsibilityScope: {
        lead: "서비스기획자는 기능과 화면의 완성도를 높이는 역할을 많이 맡지만, PM은 제품의 방향, 우선순위, 성과까지 더 넓게 책임지는 경우가 많습니다.",
    ...
    smoke: {
      activation: {
        ...
        shouldMention: [
          "서비스기획 경험은 PM 직무와 기본 구조가 많이 겹칩니다",
          "제품이 풀어야 할 문제를 정하고 우선순위를 판단하며",
          "PM 역할 확장성이 더 분명해집니다",
        ],
        shouldNotMention: [
          "고객 불편과 반복 문의를",
      ...
      boundaryCopy: {
        shouldMention: ["기획 산출물", "제품 판단력", "성과 개선"],
        shouldNotMention: [
          "PM 역량이 충분합니다",
          "PM 경험으로 볼 수 있습니다",
          "바로 PM 직무에 적합합니다",
    ...
    conflict: {
      targetOverlapRisk: "HIGH",
      sharedTargetWith: [
        "SERVICE_PLANNING_TO_PO",
        "OPERATIONS_PLANNING_TO_PRODUCT_MANAGER",
        "DATA_ANALYST_TO_PRODUCT_MANAGER",
        "PERFORMANCE_MARKETING_TO_PRODUCT_MANAGER",
      ],
      notes: "JOB_IT_DATA_DIGITAL_PRODUCT_MANAGEMENT를 PO·운영기획→PM·데이터분석→PM·퍼포먼스마케팅→PM 프로파일과 공유함. sourceJobId가 JOB_BUSINESS_SERVICE_PLANNING일 때만 발화. source set 완전 분리로 co-fire 불가.",
    },
    notes: "LOCKED copy source: docs/copy/career-transition/cases/EXPERIENCED_SERVICE_PLANNING_TO_PRODUCT_MANAGER_V2.md. Pilot applies only jobStructure and responsibilityScope to match existing 2-axis profile pattern and avoid over-explaining high-band axes.",
  },

  // ─── 운영기획 → PM ──────────────────────────────────────────────────────

  {
    id: "OPERATIONS_PLANNING_TO_PRODUCT_MANAGER",
    status: "IMPLEMENTED",
    priority: "P0",
    sourceJobIds: [
    ...
    transitionType: "ADJACENT",
    bridgeTags: ["operations_improvement", "process_bottleneck_finding", "product_requirement_translation", "cross_org_coordination"],
    limitationTags: ["operations_management_only", "product_ownership_needs_evidence", "metric_improvement_needs_evidence"],
    evidenceTags: ["ops_improvement_proposal", "automation_requirement", "feature_improvement_case", "issue_reduction_data", "admin_tool_enhancement"],
    targetAxes: ["jobStructure", "responsibilityScope"],
    targetSlots: {
      jobStructure: ["lead", "scoreReason", "criteria"],
      responsibilityScope: ["lead", "liftOrLimit"],
    ...
    smoke: {
      activation: {
        ...
        shouldMention: [
          "운영기획 경험은 PM의 문제 발견 업무와 연결될 수 있습니다",
          "그 문제를 제품 기능·정책·자동화 개선으로 바꾸는 역할입니다",
          "운영 병목을 제품 요구사항으로 정의했고",
        ],
        shouldNotMention: [
          "서비스기획 경험은 PM 직무와 기본 구조가 많이 겹칩니다",
          "데이터분석 경험은 PM의 데이터 기반 문제정의 업무와",
          "퍼포먼스마케팅 경험은 그로스 PM",
          "SQL 쿼리",
        ],
      },
      boundaryCopy: {
        shouldMention: ["운영 관리", "제품 개선 과제", "자동화"],
        shouldNotMention: [
          "PM 역량이 충분합니다",
          "PM 경험으로 볼 수 있습니다",
          "바로 PM 직무에 적합합니다",
    ...
    conflict: {
      targetOverlapRisk: "LOW",
      sharedTargetWith: [
        "SERVICE_PLANNING_TO_PRODUCT_MANAGER",
        "DATA_ANALYST_TO_PRODUCT_MANAGER",
        "PERFORMANCE_MARKETING_TO_PRODUCT_MANAGER",
      ],
      notes: "JOB_IT_DATA_DIGITAL_PRODUCT_MANAGEMENT를 서비스기획→PM·데이터분석→PM·퍼포먼스마케팅→PM 프로파일과 공유함. sourceJobIds에 JOB_CUSTOMER_OPERATIONS_OPERATION_PLANNING·JOB_BUSINESS_OPERATIONS_MANAGEMENT 포함. source set 완전 분리로 co-fire 불가.",
    },
    notes: "LOCKED copy source: docs/copy/career-transition/cases/EXPERIENCED_OPERATIONS_PLANNING_TO_PRODUCT_MANAGER_V1.md. BATCH_PM_01 member. Applies only jobStructure and responsibilityScope to match existing 2-axis profile pattern and avoid over-explaining high-band axes.",
  },

  // ─── 데이터분석 → PM ──────────────────────────────────────────────────────

  {
    id: "DATA_ANALYST_TO_PRODUCT_MANAGER",
    status: "IMPLEMENTED",
    priority: "P0",
    sourceJobIds: [
      "JOB_IT_DATA_DIGITAL_DATA_ANALYSIS",
    ...
    transitionType: "ADJACENT",
    bridgeTags: ["data_interpretation", "metric_definition", "hypothesis_testing", "product_decision_support"],
    limitationTags: ["report_dashboard_only", "product_ownership_needs_evidence", "execution_leadership_needs_evidence"],
    evidenceTags: ["cohort_analysis", "ab_test_result", "feature_improvement_recommendation", "product_metric_definition", "roadmap_contribution"],
    targetAxes: ["jobStructure", "responsibilityScope"],
    targetSlots: {
      jobStructure: ["lead", "scoreReason", "criteria"],
      responsibilityScope: ["lead", "liftOrLimit"],
    ...
    smoke: {
      activation: {
        ...
        shouldMention: [
          "데이터분석 경험은 PM의 데이터 기반 문제정의 업무와 강하게 연결될 수 있습니다",
          "분석을 바탕으로 제품 문제를 정의하고 우선순위를 결정하며",
          "개선 우선순위를 바꾸었고, 제품 실험이나 기능 개선으로",
        ],
        shouldNotMention: [
          "서비스기획 경험은 PM 직무와 기본 구조가 많이 겹칩니다",
          "운영기획 경험은 PM의 문제 발견 업무와",
          "퍼포먼스마케팅 경험은 그로스 PM",
          "SQL 쿼리",
        ],
      },
      boundaryCopy: {
        shouldMention: ["리포트", "대시보드", "제품 우선순위"],
        shouldNotMention: [
          "PM 역량이 충분합니다",
          "PM 경험으로 볼 수 있습니다",
          "바로 PM 직무에 적합합니다",
    ...
    conflict: {
      ...
      notes: "JOB_IT_DATA_DIGITAL_PRODUCT_MANAGEMENT를 서비스기획→PM·운영기획→PM·퍼포먼스마케팅→PM 프로파일과 공유함. sourceJobId가 JOB_IT_DATA_DIGITAL_DATA_ANALYSIS일 때만 발화. source set 완전 분리로 co-fire 불가.",
    },
    notes: "LOCKED copy source: docs/copy/career-transition/cases/EXPERIENCED_DATA_ANALYST_TO_PRODUCT_MANAGER_V1.md. BATCH_PM_01 member. Applies only jobStructure and responsibilityScope to match existing 2-axis profile pattern and avoid over-explaining high-band axes.",
  },

  // ─── 퍼포먼스마케팅 → PM ────────────────────────────────────────────────

  {
    id: "PERFORMANCE_MARKETING_TO_PRODUCT_MANAGER",
    status: "IMPLEMENTED",
    priority: "P0",
    sourceJobIds: [
      "JOB_MARKETING_PERFORMANCE_MARKETING",
    ...
    transitionType: "ADJACENT",
    bridgeTags: ["funnel_analysis", "conversion_optimization", "growth_experiment", "product_growth_framing"],
    limitationTags: ["ad_operations_only", "product_ownership_needs_evidence", "product_funnel_experience_needed"],
    evidenceTags: ["funnel_analysis", "ab_test_result", "conversion_improvement", "product_experience_improvement", "onboarding_retention_work"],
    targetAxes: ["jobStructure", "responsibilityScope"],
    targetSlots: {
      jobStructure: ["lead", "scoreReason", "criteria"],
      responsibilityScope: ["lead", "liftOrLimit"],
    ...
    smoke: {
      activation: {
        ...
        shouldMention: [
          "퍼포먼스마케팅 경험은 그로스 PM 또는 제품 성장 PM과 연결성이 있습니다",
          "제품 안에서 사용자가 왜 전환하지 않고 어디서 이탈하는지",
          "전환 퍼널 문제를 발견하고 제품팀과 개선 실험을 설계했으며",
        ],
        shouldNotMention: [
          "서비스기획 경험은 PM 직무와 기본 구조가 많이 겹칩니다",
          "운영기획 경험은 PM의 문제 발견 업무와",
      ...
      boundaryCopy: {
        shouldMention: ["광고 성과", "제품 퍼널", "사용자 경험 개선"],
        shouldNotMention: [
          "PM 역량이 충분합니다",
          "PM 경험으로 볼 수 있습니다",
          "바로 PM 직무에 적합합니다",
    ...
    conflict: {
      ...
      notes: "JOB_IT_DATA_DIGITAL_PRODUCT_MANAGEMENT를 서비스기획→PM·운영기획→PM·데이터분석→PM 프로파일과 공유함. sourceJobId가 JOB_MARKETING_PERFORMANCE_MARKETING일 때만 발화. source set 완전 분리로 co-fire 불가. 기존 PERFORMANCE_MARKETING_TO_SERVICE_PLANNING(target: 서비스기획)과 target이 다름.",
    },
    notes: "LOCKED copy source: docs/copy/career-transition/cases/EXPERIENCED_PERFORMANCE_MARKETING_TO_PRODUCT_MANAGER_V1.md. BATCH_PM_01 member. Applies only jobStructure and responsibilityScope to match existing 2-axis profile pattern and avoid over-explaining high-band axes.",
  },
...

  {
    ...
    conflict: {
      ...
      notes: "JOB_BUSINESS_BUSINESS_PLANNING을 PROCUREMENT 프로파일과 공유함. source set 분리로 co-fire 불가.",
    },
...

  {
    ...
    conflict: {
      ...
      notes: "JOB_BUSINESS_SERVICE_PLANNING을 CS·Marketing·MFG_QA·TechSupport 프로파일과 공유함. source set 완전 분리로 co-fire 불가. CS bridge(VOC/반복문의) 및 Marketing bridge(퍼널/전환율) 문구 재사용 금지.",
    },
...

  {
    ...
    conflict: {
      ...
      notes: "JOB_BUSINESS_SERVICE_PLANNING을 CS·Marketing·Operations·TechSupport 프로파일과 공유함. source set 완전 분리로 co-fire 불가. CS bridge(VOC/반복문의), Marketing bridge(퍼널/전환율), Operations bridge(프로세스 병목) 문구 재사용 금지.",
    },
