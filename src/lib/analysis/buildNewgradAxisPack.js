...
const AXIS5_SOFT_TRAIT_FIT_PROFILES = {
  ...
  PROCUREMENT_SCM: {
    ...
    bridgeScene: "공급업체와 협상하고, 수급 상황을 파악해 계획을 조정한 장면",
  ...
  MANUFACTURING_QUALITY_PRODUCTION: {
    ...
    bridgeScene: "생산 중 문제를 발견하고, 원인을 파악해 빠르게 대응한 장면",
  ...
  ENGINEERING_DEVELOPMENT: {
    ...
    bridgeScene: "사용자 요구를 듣고, 시제품을 만들어 테스트한 후 문제를 개선한 장면",
  ...
  DESIGN: {
    ...
    bridgeScene: "사용자 반응을 관찰하고, 디자인을 반복해서 개선한 장면",
  ...
  RESEARCH_PROFESSIONAL: {
    ...
    bridgeScene: "자료를 수집해 분석하고, 결과를 정리해 설명한 장면",
  ...
  EDUCATION_COUNSELING_COACHING: {
    ...
    bridgeScene: "학습자의 상황을 파악하고, 맞춤형 피드백을 주며 성장을 지원한 장면",
  ...
  PUBLIC_ADMINISTRATION_SUPPORT: {
    ...
    bridgeScene: "이해관계자들의 입장을 듣고, 기준에 맞게 조율해 결정을 내린 장면",
