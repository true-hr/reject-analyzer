        ...
        <div className="space-y-4 rounded-xl border border-slate-200 bg-white p-4 shadow-sm">
          ...
          <div className="border-t border-slate-100 pt-3">
            <button
              type="button"
              disabled
              className="mb-1.5 w-full cursor-not-allowed rounded-lg border border-slate-200 bg-slate-50 py-2.5 text-xs font-medium text-slate-400"
            >
              커리어 기준 저장
            </button>
            <p className="text-center text-[10px] text-slate-400">저장 기능은 곧 지원 예정입니다</p>
          </div>
        </div>
      </section>
