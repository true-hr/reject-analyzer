...
function createDemoProjectAction({
  id,
  projectName,
  date,
  endDate,
...
export const PASSMAP_DEMO_RANGE_RECORDS = [
  createDemoProjectAction({
    id: "pm-demo-project-job-posting-2026-06-10",
    projectName: "취업 준비 스프린트",
    date: "2026-06-10",
    endDate: "2026-06-12",
    title: "지원 공고 분석하기",
    task: "지원할 공고 3개를 비교하고 요구 역량과 반복 키워드를 정리하기",
    result: "PM 공고 3개에서 데이터 기반 개선, 협업 조율, 사용자 문제 정의 키워드를 추렸습니다.",
    summary: "취업 준비 스프린트의 첫 단계로 공고 요구사항을 정리했습니다.",
    reflectedSentence: "PM 공고 3개를 비교해 핵심 요구 역량과 반복 키워드를 정리했습니다.",
    strengthTags: ["공고 분석", "우선순위"],
    skillTags: ["PM", "리서치"],
    projectInsight: "다음 Action에서는 공고 키워드에 맞는 대표 경험을 연결합니다.",
    projectGoal: "지원 준비 흐름을 공고 분석부터 제출 자료까지 끊기지 않게 관리합니다.",
    projectContext: "프로젝트뷰 Gantt 보드 QA용 데모 Action입니다.",
    actionStatus: "completed",
  }),
  createDemoProjectAction({
    id: "pm-demo-project-portfolio-cases-2026-06-13",
    projectName: "포트폴리오 정리",
    date: "2026-06-13",
    endDate: "2026-06-17",
    title: "대표 경험 3개 고르기",
    task: "포트폴리오에 넣을 대표 경험 3개를 고르고 문제, 행동, 결과 기준으로 분류하기",
    summary: "포트폴리오 사례 선정을 진행 중입니다.",
    strengthTags: ["경험 정리", "문서화"],
    skillTags: ["포트폴리오", "스토리텔링"],
    projectInsight: "선정한 경험마다 성과 수치가 있는지 확인해야 합니다.",
    projectGoal: "면접에서 바로 설명할 수 있는 포트폴리오 사례를 준비합니다.",
    projectContext: "진행 중 상태의 프로젝트 Action 데모입니다.",
    actionStatus: "in_progress",
  }),
  createDemoProjectAction({
    id: "pm-demo-project-interview-star-2026-06-18",
    projectName: "면접 답변 준비",
    date: "2026-06-18",
    endDate: "2026-06-20",
    title: "STAR 답변 초안 쓰기",
    task: "자주 나오는 면접 질문 5개에 대해 STAR 구조로 답변 초안 쓰기",
    summary: "면접 답변 초안을 작성할 예정입니다.",
    strengthTags: ["커뮤니케이션", "회고"],
    skillTags: ["면접", "구조화"],
    projectInsight: "답변마다 한 가지 대표 사례만 연결해 짧게 말할 수 있게 준비합니다.",
    projectGoal: "반복해서 사용할 수 있는 면접 답변 초안을 만듭니다.",
    projectContext: "예정 상태의 프로젝트 Action 데모입니다.",
    actionStatus: "planned",
  }),
  createDemoProjectAction({
    id: "pm-demo-project-result-metric-2026-06-09",
    projectName: "포트폴리오 정리",
    date: "2026-06-09",
    endDate: "2026-06-11",
    title: "성과 수치 보강하기",
    task: "포트폴리오 사례마다 전후 변화, 처리량, 시간 단축 같은 성과 수치 보강하기",
    summary: "마감이 지난 Action으로 결과 근거 보강이 필요합니다.",
    strengthTags: ["성과 정리", "근거 보강"],
    skillTags: ["metrics", "case-study"],
    projectInsight: "수치를 보강하면 이력서 문장과 면접 답변으로 바로 이어질 수 있습니다.",
    projectGoal: "포트폴리오 사례를 정량 근거가 있는 이야기로 정리합니다.",
    projectContext: "확인 필요 상태의 프로젝트 Action 데모입니다.",
