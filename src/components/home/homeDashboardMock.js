...
export const PASSMAP_DEMO_RANGE_RECORDS = [
  {
    id: "pm-demo-project-portfolio-outline-2026-06-10",
    date: "2026-06-10",
    ...
    endDate: "2026-06-12",
    projectPeriod: "2026-06-10 ~ 2026-06-12",
    title: "Portfolio story outline",
    task: "Define the portfolio story and select two proof projects.",
    result: "Selected two project examples and grouped evidence by problem, action, and result.",
    summary: "Portfolio Refresh action for story framing and evidence selection.",
    reflectedSentence: "Structured portfolio evidence into problem-action-result blocks for PM interview readiness.",
    strengthTags: ["planning", "documentation"],
    skillTags: ["portfolio", "storytelling"],
    rawPayload: {
      mode: "project-action",
      track: "project",
      recordType: "teamProject",
      ...
      startDate: "2026-06-10",
      endDate: "2026-06-12",
      projectActions: "Define the portfolio story and select two proof projects.",
      projectResult: "Selected two project examples and grouped evidence by problem, action, and result.",
      projectInsight: "Next, turn each proof project into a one-page case study.",
      projectGoal: "Prepare a concise portfolio narrative for PM interviews.",
      projectContext: "Demo QA record for project Action drawer validation.",
  ...
  {
    id: "pm-demo-project-portfolio-case-2026-06-13",
    date: "2026-06-13",
    ...
    endDate: "2026-06-17",
    projectPeriod: "2026-06-13 ~ 2026-06-17",
    title: "Write first portfolio case",
    task: "Draft the first case study with measurable context and decision points.",
    result: "",
    summary: "Portfolio Refresh action for drafting a case study.",
    reflectedSentence: "",
    strengthTags: ["writing", "analysis"],
    skillTags: ["case-study", "metrics"],
    rawPayload: {
      mode: "project-action",
      track: "project",
      recordType: "teamProject",
      ...
      startDate: "2026-06-13",
      endDate: "2026-06-17",
      projectActions: "Draft the first case study with measurable context and decision points.",
      projectResult: "",
      projectInsight: "Add one quantified before-and-after signal before marking complete.",
      projectGoal: "Prepare a concise portfolio narrative for PM interviews.",
      projectContext: "Demo QA record for in-progress project Action drawer validation.",
  ...
  {
    id: "pm-demo-project-interview-map-2026-06-18",
    date: "2026-06-18",
    ...
    workType: "project",
    work_type: "project",
    projectName: "Interview Prep Sprint",
    project_name: "Interview Prep Sprint",
    startDate: "2026-06-18",
    endDate: "2026-06-20",
    projectPeriod: "2026-06-18 ~ 2026-06-20",
    title: "Map interview answer themes",
    task: "Map five likely interview questions to project examples.",
    result: "",
    summary: "Interview Prep Sprint action for answer mapping.",
    reflectedSentence: "",
    strengthTags: ["communication", "reflection"],
    skillTags: ["interview", "mapping"],
    rawPayload: {
      mode: "project-action",
      track: "project",
      recordType: "teamProject",
      ...
      startDate: "2026-06-18",
      endDate: "2026-06-20",
      projectActions: "Map five likely interview questions to project examples.",
      projectResult: "",
      projectInsight: "Use one example per answer and keep the structure concise.",
      projectGoal: "Prepare repeatable interview answer drafts.",
      projectContext: "Demo QA record for planned project Action drawer validation.",
  ...
  {
    id: "pm-demo-project-interview-review-2026-06-09",
    date: "2026-06-09",
    ...
    endDate: "2026-06-11",
    projectPeriod: "2026-06-09 ~ 2026-06-11",
    title: "Review delayed answer draft",
    task: "Review an answer draft that still needs concrete result evidence.",
    result: "",
    summary: "Interview Prep Sprint action that needs result review.",
    reflectedSentence: "",
    strengthTags: ["review", "evidence"],
    skillTags: ["interview", "result-writing"],
    rawPayload: {
      mode: "project-action",
      track: "project",
      recordType: "teamProject",
      ...
      startDate: "2026-06-09",
      endDate: "2026-06-11",
      projectActions: "Review an answer draft that still needs concrete result evidence.",
      projectResult: "",
      projectInsight: "Add the result evidence before using this answer in practice.",
      projectGoal: "Prepare repeatable interview answer drafts.",
      projectContext: "Demo QA record for needs-review project Action drawer validation.",
