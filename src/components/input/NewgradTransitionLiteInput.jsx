...
const PROJECT_ROLE_OPTIONS = ["기획", "마케팅", "데이터 분석", "디자인", "프론트엔드", "백엔드", "운영 / 지원", "재무 / 회계 분석", "연구 / R&D", "교육 / 상담 기획", "제조 / 품질 분석"];
const PROJECT_OUTCOME_OPTIONS = ["진행 중심", "결과물 완성", "발표 / 제출 / 시연", "실제 적용 / 운영 반영", "수상 / 선발 / 우수성과"];
const ROLE_FAMILY_OPTIONS = ["기획", "마케팅", "영업 / 사업개발", "데이터 / 분석", "디자인", "개발", "운영 / 고객지원", "인사 / 경영지원", "재무 / 회계 / 세무 보조", "구매 / SCM / 물류", "제조 / 생산 / 품질 보조", "연구 / R&D / 실험 보조", "교육 / 상담 / 코칭", "콘텐츠 / SNS 운영", "홍보 / PR / 대외협력", "상품 / MD / 이커머스 운영", "법무 / 공공행정", "데이터 라벨링 / AI 운영 / QA", "매장 / 현장운영 / 서비스"];
