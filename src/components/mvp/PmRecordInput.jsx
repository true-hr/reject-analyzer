                ...
                {selectedGuide ? (
                  <div className="rounded-2xl border border-slate-200 bg-slate-50/80 p-3.5">
                    <div className="flex items-center gap-1.5 mb-2">
                      ...
                      <span className="text-xs font-semibold text-slate-500">{selectedGuideTitle}</span>
                    </div>
                    <div className="space-y-2.5 text-[12.5px] leading-relaxed text-slate-600">
                      {selectedGuide.guidance && (
                        <p>{selectedGuide.guidance}</p>
                      )}
                      {selectedGuide.steps?.length ? (
                        <ol className="space-y-1.5 pl-4">
                          {selectedGuide.steps.map((step, idx) => (
                            <li key={`step-${idx}`} className="list-decimal text-slate-500">
