...
export const AXIS_JOB_RATIONALE_MAP = {
  axis1: {
    base: "전공이 목표 직무의 기본 사고방식과 핵심 역할에 얼마나 직접 연결되는지를 봅니다.",
    bySubVertical: {
      SERVICE_PLANNING:  "서비스기획은 기능 정의와 구현 협업이 핵심이라, 전공 교육이 이 과업과 맞닿는지를 봅니다.",
      UX_SERVICE_DESIGN: "UX·서비스 설계는 흐름 설계가 핵심 과업이라, 전공 학습이 직무 기초와 연결되는지를 봅니다.",
      B2B_SALES:         "B2B 영업은 고객 발굴과 제안이 핵심 과업이라, 전공에서 배운 기초가 직무와 겹치는지를 봅니다.",
      BRAND_MARKETING:   "브랜드 마케팅은 메시지 설계와 캠페인 기획이 핵심이라, 전공 이해가 직무 과업과 맞는지를 봅니다.",
      RECRUITING:        "채용 업무는 요구사항 정리와 프로세스 운영이 핵심이라, 전공 학습이 이 기초 역할과 연결되는지를 봅니다.",
    },
  },
  axis2: {
