...
const JOB_SPECIFIC_AXIS1_ACTIONS = Object.freeze({
  ...
  PRODUCT_MARKETING_PMM: Object.freeze({
    // @MX:NOTE: PMM core actions (market positioning, customer segmentation, messaging, pricing)
    foundationActions: [
      "시장 구조와 경쟁 환경 분석",
      "고객 세그먼트 파악 및 니즈 이해",
      "제품 메시지와 포지셔닝 설계",
    ...
    missingActions: [
      "시장 조사와 경쟁사 분석을 통해 포지셔닝 기준을 실제로 잡아본 적이 있는지",
      "고객 세그먼트별로 메시지를 달리 설계하고 검증한 경험이 있는지",
      "제품 출시 후 매출, 전환율, 고객 획득 비용 같은 핵심 지표를 분석하고 개선해봤는지",
    ],
    nextEvidenceActions: [
      "시장 규모 및 고객 수요 조사",
