...
export const NEWGRAD_MAJOR_BRIDGE_REGISTRY = Object.freeze({
  ...
  BIO_LIFE_SCIENCE: Object.freeze({
    ...
    jobBridgeMap: {
      ...
      QUALITY_CONTROL: Object.freeze({
        majorDefinition: "바이오·생명과학은 세포, 미생물, 생화학 반응을 이해하고, 그 원리를 실험과 분석에 적용하는 기초를 제공합니다.",
        jobConnection: "품질관리(QC)는 원재료·반제품·완제품이 규격을 충족하는지 검사하고 이상을 조기에 차단하는 역할입니다. 생명과학 배경이 있으면 의약품·바이오 제품의 미생물 시험, 이화학 시험, 성분 분석의 원리를 이해하고 검사 기준과 결과의 의미를 파악하는 데 도움이 됩니다.",
        careerBridge: "따라서 바이오·생명과학에서 배운 실험 설계, 분석 방법, 데이터 해석은 QC 업무에서 시험법 이해, 기준 적합성 판단, 이상 원인 추정으로 연결될 수 있습니다. 다만 GMP 규정, 문서화 절차, 실제 검사 장비 운용은 현장 경험으로 보강이 필요합니다.",
        appealingCourses: [
          "분석화학",
          "미생물학",
          "생화학",
