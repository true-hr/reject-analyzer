...
const AXIS1_ROLE_READING_PROFILES = {
  ...
  JOB_CUSTOMER_OPERATIONS_CX_PLANNING: {
    ...
    followUpActions: ["수업이나 프로젝트에서 고객 여정, 서비스 프로세스, 만족도 조사, VOC 분석을 다룬 장면", "고객 불편을 발견하고 개선안을 제안한 경험", "실제 고객과 접점이 있었던 아르바이트나 운영 경험"],
  },
  ...
  JOB_BUSINESS_MERCHANDISING: {
    ...
    followUpActions: ["수업이나 프로젝트에서 상품 기획, 소비자 조사, 시장 분석, 판매 전략을 다룬 장면", "쇼핑몰 운영, 제품 판매, 브랜드 분석, 카테고리 리서치 경험", "MD 직무는 전공보다 상품군 이해와 숫자 기반 판매 판단 경험이 함께 중요"],
  },
