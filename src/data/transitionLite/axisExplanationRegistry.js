...
const NEWGRAD_AXIS2_INDUSTRY_GUIDES = {
  ...
  IND_MANUFACTURING_MACHINERY_INDUSTRIAL_EQUIPMENT: {
    label: "제조업 (기계·산업장비)",
    structure: "제조업·기계·산업장비 산업은 부품을 설계·조달해 기계를 생산하고, 품질·성능을 보증하며, 고객에게 설치·유지·AS까지 제공하는 구조입니다. 원가 효율성, 생산 공정, 제품 신뢰성, 공급망 안정성, 납기 준수가 산업 이해의 핵심입니다.",
    ...
    gap: "다만 현재 입력만으로는 실제 생산 라인 운영, 공정 최적화, 품질 이슈 해결, 원가·납기 관리, 부품 공급망 조율, 제조 데이터 분석, 기술 표준과 규제 대응을 다뤄봤는지는 드러나지 않습니다.",
    lift: "이 연결을 더 강하게 보려면, 수업이나 프로젝트/인턴 경험 안에서 공정 분석, 생산 계획, 품질 관리, 원가 절감, 공급망 개선, 제조 현장 관찰, 기계 운영이나 산업 파트너 협업을 다룬 장면이 있었는지 함께 떠올려보는 것이 좋습니다.",
  },
};
