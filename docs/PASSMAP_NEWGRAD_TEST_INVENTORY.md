...
| NG-COVERAGE-DEV-001 | Coverage | 비전공 + 데이터분석 + 프로젝트/실무/자격증 전무 | P1 | FIXTURED | NO_EVIDENCE_NON_MAJOR_FOR_DEV_DATA 발화 계약. responsibilityScope.lead/scoreReason/criteria/liftOrLimit(4슬롯). E-3 coverage gap 조사 후 추가. 기존 NG-JOB-DATA-001(certs 있음), NG-JOB-DEV-002(projects 있음)와 비중복. | 2026-04-30 | - | PASSING (runner 11 PASS, Round E-4) |
