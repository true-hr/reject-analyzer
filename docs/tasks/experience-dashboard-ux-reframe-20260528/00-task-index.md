...
7. `50-artifact-e-data-connection.md`
8. `60-artifact-f-cta-routing.md`
9. `70-artifact-g-responsive-qa.md`
10. `80-artifact-h-verification-definition.md`
11. `90-implementation-plan.md`
12. `99-handoff-template.md`
...
6. 산출물 F: CTA 연결 기준
7. 산출물 G: 모바일/반응형 기준
8. 산출물 H: 검증 기준과 완료 정의
9. 검증 및 handoff

## 현재 구체화 수준

- `10-artifact-a-top-summary-card.md`: 상세 정의 완료.
- `20-artifact-b-calendar-flow.md`: 상세 정의 완료.
- `30-artifact-c-bottom-flow.md`: 상세 정의 완료.
- `40-copy-and-tone-rules.md`: 상세 정의 완료.
- `50-artifact-e-data-connection.md`: 상세 정의 완료.
- `60-artifact-f-cta-routing.md`: 상세 정의 완료.
- `70-artifact-g-responsive-qa.md`: 상세 정의 완료.
- `80-artifact-h-verification-definition.md`: 상세 정의 완료.
- `90-implementation-plan.md`, `99-handoff-template.md`: 구현 전/후 운영용 문서.
